...
/*! \file
 *
 * \brief Stream to an icecast server via ICES (see contrib/iaxproxy-ices.xml)
 *
...
/*** DOCUMENTATION
	<application name="ICES" language="en_US">
		...
		<description>
			...
			A configuration file must be supplied for ices (see contrib/iaxproxy-ices.xml).</para>
