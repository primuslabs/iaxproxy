...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 309857 $")

#include "iaxproxy/paths.h"	/* use ast_config_AST_MONITOR_DIR */
		...
		<syntax>
			<parameter name="file" required="true" argsep=".">
				<argument name="filename" required="true">
					...
					creates the file in the configured monitoring directory from <filename>iaxproxy.conf.</filename></para>
				</argument>
