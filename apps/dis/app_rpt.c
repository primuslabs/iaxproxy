 ...
 *
 *  To send an iaxproxy (*) while dialing or talking on phone,
...
#define	FUNCCHAR '*'
#define	ENDCHAR '#'
#define	EXTNODEFILE "/var/lib/iaxproxy/rpt_extnodes"
...
/*
	send iaxproxy frame text message on the current tx channel
*/
...
struct dahdi_params par;
	...
	/* allocate a pseudo-channel thru iaxproxy */
