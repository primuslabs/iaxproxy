...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 320236 $")
...
enum {
	...
	/*! If set iaxproxy will exit conference when key defined in p() option is pressed */
	CONFFLAG_KEYEXIT = (1 << 2),
	/*! If set iaxproxy will provide a menu to the user when '*' is pressed */
 ...
 * \param chan The iaxproxy channel
 *
