 ...
 *             When iaxproxy is restarted, each agent will be automatically
 ...
 * Added Priority jumping code for adding and removing queue members by Jonathan Stanton <iaxproxy@doilooklikeicare.com>
 *
...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 317575 $")
...
#include "iaxproxy/monitor.h"
#include "iaxproxy/utils.h"
#include "iaxproxy/causes.h"
#include "iaxproxy/astdb.h"
#include "iaxproxy/devicestate.h"
#include "iaxproxy/stringfields.h"
#include "iaxproxy/event.h"
#include "iaxproxy/astobj2.h"
#include "iaxproxy/strings.h"
#include "iaxproxy/global_datastores.h"
#include "iaxproxy/taskprocessor.h"
...
static void queue_set_param(struct call_queue *q, const char *param, const char *val, int linenum, int failunknown)
{
	if (!strcasecmp(param, "musicclass") || 
		...
		if (strategy == QUEUE_STRATEGY_LINEAR) {
			ast_log(LOG_WARNING, "Changing to the linear strategy currently requires iaxproxy to be restarted.\n");
			return;
		}
		q->strategy = strategy;
