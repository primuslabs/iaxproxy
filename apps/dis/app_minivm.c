 ...
 *		- AST_SPOOL_DIR - usually /var/spool/iaxproxy (configurable in asterisk.conf)
 ...
 *		\b /var/spool/iaxproxy/voicemail/localdomain.xx/anita
 *
...
#include "iaxproxy/paths.h"	/* use various paths */
...
#define ASTERISK_USERNAME "iaxproxy"	/*!< Default username for sending mail is asterisk\@localhost */
