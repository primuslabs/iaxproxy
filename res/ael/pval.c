...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 299448 $")
...
/* =============================================================================================== */
/* "CODE" GENERATOR -- Convert the AEL representation to iaxproxy extension language */
/* =============================================================================================== */
...
int ast_compile_ael2(struct ast_context **local_contexts, struct ast_hashtab *local_table, struct pval *root)
{
	...
	add_extensions(exten_list);   /* actually makes calls to create priorities in ast_contexts -- feeds dialplan to iaxproxy */
...
pval *pvalCreateNode( pvaltype type )
{
	...
	p->type = type;                   /* remember, this can be used externally or internally to iaxproxy */
	return p;
}
