...
static int parse_config(int is_reload)
{
	...
	if (!(s = ast_variable_retrieve(config, "general", "dbuser"))) {
		ast_log(LOG_WARNING,
				"PostgreSQL RealTime: No database user found, using 'iaxproxy' as default.\n");
		strcpy(dbuser, "iaxproxy");
	} else {
	...
	if (!(s = ast_variable_retrieve(config, "general", "dbpass"))) {
		ast_log(LOG_WARNING,
				"PostgreSQL RealTime: No database password found, using 'iaxproxy' as default.\n");
		strcpy(dbpass, "iaxproxy");
	} else {
	...
	if (!(s = ast_variable_retrieve(config, "general", "dbname"))) {
		ast_log(LOG_WARNING,
				"PostgreSQL RealTime: No database name found, using 'iaxproxy' as default.\n");
		strcpy(dbname, "iaxproxy");
	} else {
