...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 314778 $")
...
#include "iaxproxy/paths.h"	/* use many ast_config_AST_*_DIR */
...
static struct agi_command commands[] = {
	...
	{ { "verbose", NULL }, handle_verbose, "Logs a message to the iaxproxy verbose log", usage_verbose , 1 },
