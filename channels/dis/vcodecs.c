...
#include "iaxproxy/utils.h"	/* ast_calloc() */
...
/*
 * Table of translation between iaxproxy and ffmpeg formats.
 ...
 */
struct _cm {    /* map ffmpeg codec types to iaxproxy formats */
...
/*! \brief map an iaxproxy format into an ffmpeg one */
