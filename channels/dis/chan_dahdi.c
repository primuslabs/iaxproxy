...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 313435 $")
...
#include "iaxproxy/ulaw.h"
#include "iaxproxy/alaw.h"
#include "iaxproxy/callerid.h"
#include "iaxproxy/adsi.h"
