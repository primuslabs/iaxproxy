 ...
 *
 * UNISTIM channel driver for iaxproxy
 *
...
#include "iaxproxy/paths.h"	/* ast_config_AST_LOG_DIR used in (too ?) many places */
...
/*! Beware, G729 and G723 are not supported by iaxproxy, except with the proper licence */
 ...
 * Runs in the iaxproxy main thread, so don't do anything useful
