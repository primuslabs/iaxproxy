...
/*! \brief
  * Callback for sending digits from H.323 up to iaxproxy
  *
  */
...
/*! \brief
  * Call-back function passing remote ip/port information from H.323 to iaxproxy
  *
  * Returns nothing
  */
...
/*! \brief
  *	Call-back function to signal iaxproxy that the channel has been answered
  * Returns nothing
  */
static void connection_made(unsigned call_reference, const char *token)
{
	...
	/* Inform iaxproxy about remote party connected only on outgoing calls */
	if (!pvt->outgoing) {
		ast_mutex_unlock(&pvt->lock);
		return;
	}
...
static int answer_call(unsigned call_reference, const char *token)
{
	...
	/* allocate a channel and tell iaxproxy about it */
...
/*! \brief
  *  Call-back function to signal iaxproxy that the channel is ringing
  *  Returns nothing
  */
