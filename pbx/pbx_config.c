...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 315393 $")

#include <ctype.h>

#include "iaxproxy/paths.h"	/* ast_config_AST_CONFIG_DIR */
#include "iaxproxy/pbx.h"
#include "iaxproxy/config.h"
#include "iaxproxy/module.h"
#include "iaxproxy/logger.h"
#include "iaxproxy/cli.h"
#include "iaxproxy/channel.h"	/* AST_MAX_EXTENSION */
...
static char *handle_cli_dialplan_save(struct ast_cli_entry *e, int cmd, struct ast_cli_args *a)
{
	...
	case CLI_INIT:
		...
		e->usage =
			...
			"\n"
			"Example: dialplan save                 (/etc/iaxproxy/extensions.conf)\n"
