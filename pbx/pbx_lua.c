...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 317859 $")
...
/*!
 * \brief Create the 'application' metatable, used to execute iaxproxy
...
static int lua_error_function(lua_State *L)
{
	...
	/* pass number arguments right through back to iaxproxy*/
	if (lua_isnumber(L, -1)) {
		return 1;
	}
