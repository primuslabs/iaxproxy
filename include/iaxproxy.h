/*
 * IAXProxy -- A simple IAX -> SIP brdige based upon Asterisk 
 *
...
/*! \file
 * \brief IAXPROXY main include file. File version handling, generic pbx functions.
 */
