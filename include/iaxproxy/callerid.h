...
/*! \brief Generate Caller-ID spill from the "callerid" field of iaxproxy (in e-mail address like format)
 ...
 *
 * Acts like callerid_generate except uses an iaxproxy format callerid string.
 */
