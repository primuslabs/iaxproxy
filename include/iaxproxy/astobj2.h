/*
 * astobj2 - replacement containers for iaxproxy data structures.
 *
...
multiple times on the same object, commonly fatal to iaxproxy.
...
before the #include "iaxproxy/astobj2.h" line, and add a descriptive
tag to each call. Recompile, and run Asterisk, exit iaxproxy with
