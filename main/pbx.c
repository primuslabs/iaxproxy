 ...
 * https://issues.iaxproxy.org/view.php?id=17643
 */
...
void ast_merge_contexts_and_delete(struct ast_context **extcontexts, struct ast_hashtab *exttable, const char *registrar)
{
	...
	*/
	...
	/* the old list and hashtab no longer are relevant, delete them while the rest of iaxproxy
