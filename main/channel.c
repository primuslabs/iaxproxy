...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 313579 $")
...
#include "iaxproxy/paths.h"	/* use ast_config_AST_SYSTEM_NAME */

#include "iaxproxy/pbx.h"
#include "iaxproxy/frame.h"
#include "iaxproxy/mod_format.h"
...
#include "iaxproxy/transcap.h"
#include "iaxproxy/devicestate.h"
#include "iaxproxy/sha1.h"
#include "iaxproxy/threadstorage.h"
#include "iaxproxy/slinfactory.h"
#include "iaxproxy/audiohook.h"
#include "iaxproxy/timing.h"
 ...
 * must be able to build iaxproxy even without it (using a loadable 'say'
