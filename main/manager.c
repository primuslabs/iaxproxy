/*
 * iaxproxy -- An open source telephony toolkit.
 *
...
/* Patched forward the patch for AST-2012-005 */
 ...
 * - AMI-related API functions, used by internal iaxproxy components
...
#include "iaxproxy/paths.h"	/* use various ast_config_AST_* */
#include <ctype.h>
#include <sys/time.h>
#include <signal.h>
#include <sys/mman.h>
