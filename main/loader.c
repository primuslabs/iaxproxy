...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 276442 $")

#include "iaxproxy/_private.h"
#include "iaxproxy/paths.h"	/* use ast_config_AST_MODULE_DIR */
#include <dirent.h>
