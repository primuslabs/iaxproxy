...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 300520 $")
...
/*!
 *  \brief Get the content of a field (synopsis, description, etc) from an iaxproxy document tree
...
int ast_xmldoc_load_documentation(void)
{
	...
	if ((cfg = ast_config_load2("iaxproxy.conf", "" /* core can't reload */, cnfflags)) && cfg != CONFIG_STATUS_FILEINVALID) {
	...
	/* register function to be run when iaxproxy finish. */
